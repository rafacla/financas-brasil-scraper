...
@app.get("/api/cotas/{cnpj}", response_model=list[CotasFundoResponse])
@app.get("/api/cotas/{cnpj}/{data_de}", response_model=list[CotasFundoResponse])
@app.get("/api/cotas/{cnpj}/{data_de}/{data_ate}", response_model=list[CotasFundoResponse])
